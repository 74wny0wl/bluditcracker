...
class BluditCracker:
    ...
    def __auto_adjust_sleep_time(self, sleep_time_in_seconds, last_credentials_index):
    ...
    def find_credentials_with_bruteforce_bypass(self, credentials_dictionary, sleep_time_in_seconds=60):
        ...
        while searching:
            try:
                user_credentials = self.find_credentials(credentials_dictionary)
                searching = False
            ...
            if searching:
                ...
                sleep_time_in_seconds = self.__auto_adjust_sleep_time(sleep_time_in_seconds, last_credentials_index)
...
def main():
    ...
    username, password = bludit_cracker.find_credentials_with_bruteforce_bypass(credentials_dictionary, sleep_time_in_seconds=script_args.s)
